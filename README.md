...
- Clone the provided sample content model template using ```ccm clone-template --model [your-model-name] --template blog```
...
## Clean up!
Because of how GitHub works, I added a ```_DELETE-this-file.txt``` in the content-models folder so that when you pull the repo, you get that folder.  Empty folders don't come down. Feel free to delete that file.
